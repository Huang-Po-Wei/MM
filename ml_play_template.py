...
def ml_loop():
    ...
    while True:
        ...
        if(len(ball_position_history)==1):
            ...
            ball_going_down = 1
            deltay=ball_position_history[-1][1]-ball_position_history[-2][1]
            deltax=ball_position_history[-1][0]-ball_position_history[-2][0]
        else:
            ball_going_down=0
        ...
        if ball_going_down == 1 and ball_position_history[-1][1] >= 0:
            ball_destination = ball_position_history[-1][0]+ ((395-ball_position_history[-1][1])/deltay)*deltax
